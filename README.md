...
This program (download <a rel="nofollow" target="_blank" href="http://fromto.hig.se/~bjg/HeadTailBreaksCode/HeadTailBreakApp.rar"> <i>here</i></a></font></font>) is for obtaining related metrics of head/tail breaks on single data array, based on the follwing papers:
